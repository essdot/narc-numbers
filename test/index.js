...
test('generator', t => {
  ...
  t.equal(gen.next().value, 153)
  t.equal(gen2.next().value, 153)
  t.equal(gen.next().value, 370)
  t.equal(gen2.next().value, 370)
...
test('generator takes argument', t => {
  ...
  t.equal(gen.next().value, 153)
  t.equal(gen.next(2).value, 153)
  t.equal(gen.next(3).value, 153)
  t.equal(gen.next().value, 370)
  t.equal(gen.next().value, 371)
